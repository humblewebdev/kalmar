...
$data = $wpdb->get_results("SELECT careers_introduction, careers_benefits, careers_jobOppurtunities, careers_smallBusiness FROM wp_dummy_sitecareers WHERE careers_id = 2");
?>
<h2>Commercial Careers Page <span style="font-size: .6em"> - Each section creates its own tab</span></h2>
<div class="wrapper">
	<div class="well">
